...
const FoodRegister = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-600">
      <div className="bg-white flex rounded-3xl shadow-lg overflow-hidden w-[95%] md:w-[80%] lg:w-[70%]">
        {/* Left Side - Form */}
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8">
          {/* Logo */}
          <div className="text-center mb-6">
            <h1 className="text-4xl font-bold text-orange-600">Foodle</h1>
            <p className="text-sm text-gray-500">Register as Food Partner 🍔</p>
          </div>

          {/* Title */}
          <h2 className="text-2xl font-bold mb-2">Partner Register</h2>
          <p className="text-gray-500 mb-6">Create your food partner account</p>
